...
public class ManagerTest {
	...
	public void updateProductCatalog() {
		...
		MT_Mbi.updateProduct("gcpid1", p1);
		ProductCatalog p2 = MT_Mbi.viewProductById("gcpid1");
	...
	public void updateNullProductCatalog() {
		...
		ProductCatalog p1 = new ProductCatalog(update);
		MT_Mbi.updateProduct("gcpid4", p1);
		ProductCatalog p2 = MT_Mbi.viewProductById("gcpid1");
	...
	public void viewTheSystemManager() {
		Manager manager = MT_Mbi.viewManagerById("mid0");
		assertEquals("Super User",manager.getName());
	}
	@Test
	public void viewNonExistingManager() {
		Manager manager = MT_Mbi.viewManagerById("mid5");
	...
	public void viewProductById() {
		ProductCatalog p2 = MT_Mbi.viewProductById("gcpid1");
		ProductCatalog p3 = MT_Mbi.viewProductById("gcpid1");
